namespace SmartFran.Components.Models;
...
{
    public string Color { get; set; } = "#8a00cb";
    public string Bg    { get; set; } = "#f5d9ff";
    ...
    public static NivelConfig Get(string nivel) => nivel switch
    {
        ...
        _          => new() { Color = "#8a00cb", Bg = "#f5d9ff", Icon = "workspace_premium" },
    };
}
